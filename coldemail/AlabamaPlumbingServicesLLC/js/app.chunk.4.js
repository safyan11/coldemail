    ...
    ["90"], {
        84345: function(e, t, i) {
            ...
            a.define("slider", e.exports = function(e, t) {
                ...
                function g() {
                    (i = c.find(h)).length && (i.each(b), d || (x(), a.resize.on(w), a.redraw.on(l.redraw)))
                }
                ...
                function b(t, i) {
                    ...
                    r || (r = e.data(i, h, {
                        ...
                        el: a,
                        config: {}
                    })), r.mask = a.children(".w-slider-mask"), r.left = a.children(".w-slider-arrow-left"), r.right = a.children(".w-slider-arrow-right"), r.nav = a.children(".w-slider-nav"), r.slides = r.mask.children(".w-slide"), r.slides.each(m.reset), p && (r.maskWidth = 0), void 0 === a.attr("role") && a.attr("role", "region"), void 0 === a.attr("aria-label") && a.attr("aria-label", "carousel");
                    var n = r.mask.attr("id");
                    if (n || (n = "w-slider-mask-" + t, r.mask.attr("id", n)), o || r.ariaLiveLabel || (r.ariaLiveLabel = e('<div aria-live="off" aria-atomic="true" class="w-slider-aria-label" data-wf-ignore />').appendTo(r.mask)), r.left.attr("role", "button"), r.left.attr("tabindex", "0"), r.left.attr("aria-controls", n), void 0 === r.left.attr("aria-label") && r.left.attr("aria-label", "previous slide"), r.right.attr("role", "button"), r.right.attr("tabindex", "0"), r.right.attr("aria-controls", n), void 0 === r.right.attr("aria-label") && r.right.attr("aria-label", "next slide"), !f.support.transform) {
                        r.left.hide(), r.right.hide(), r.nav.hide(), d = !0;
                        return
                    }
                    r.el.off(h), r.left.off(h), r.right.off(h), r.nav.off(h), y(r), o ? (r.el.on("setting" + h, O(r)), E(r), r.hasTimer = !1) : (r.el.on("swipe" + h, O(r)), r.left.on("click" + h, W(r)), r.right.on("click" + h, A(r)), r.left.on("keydown" + h, T(r, W)), r.right.on("keydown" + h, T(r, A)), r.nav.on("keydown" + h, "> div", O(r)), r.config.autoplay && !r.hasTimer && (r.hasTimer = !0, r.timerCount = 1, C(r)), r.el.on("mouseenter" + h, R(r, !0, "mouse")), r.el.on("focusin" + h, R(r, !0, "keyboard")), r.el.on("mouseleave" + h, R(r, !1, "mouse")), r.el.on("focusout" + h, R(r, !1, "keyboard"))), r.nav.on("click" + h, "> div", O(r)), u || r.mask.contents().filter(function() {
                ...
                function R(t, i, a) {
                    return function(r) {
                        ...
                        i ? (t.ariaLiveLabel.attr("aria-live", "polite"), t.hasTimer && E(t)) : (t.ariaLiveLabel.attr("aria-live", "off"), t.hasTimer && C(t))
                    }
                }
                ...
                function O(i) {
                    return function(r, s) {
                        ...
                        if (o && "setting" === r.type) {
                            ...
                            return d = s.select, l = null, d === i.slides.length && (g(), M(i)), t.each(i.anchors, function(t, i) {
                        ...
                        if ("swipe" === r.type) return f.disableSwipe || a.env("editor") ? void 0 : "left" === s.direction ? A(i)() : "right" === s.direction ? W(i)() : void 0;
                ...
                function L(t, i) {
                    ...
                    var n = i.index,
                        d = {};
                    n < 0 ? (n = r.length - 1, a.infinite && (d.x = -t.endX, d.from = 0, d.to = r[0].width)) : n >= r.length && (n = 0, a.infinite && (d.x = r[r.length - 1].width, d.from = -r[r.length - 1].x, d.to = d.from - d.x)), t.index = n;
                    var l = t.nav.children().eq(n).addClass("w-active").attr("aria-pressed", "true").attr("tabindex", "0");
                    t.nav.children().not(l).removeClass("w-active").attr("aria-pressed", "false").attr("tabindex", "-1"), a.hideArrows && (t.index === r.length - 1 ? t.right.hide() : t.right.show(), 0 === t.index ? t.left.hide() : t.left.show());
                    var c = t.offsetX || 0,
                        ...
                        R = "opacity " + y + "ms " + b,
                        T = "transform " + y + "ms " + b;
                    if (v.find(s).removeAttr("tabindex"), v.removeAttr("aria-hidden"), v.find("*").removeAttr("aria-hidden"), x.find(s).attr("tabindex", "-1"), x.attr("aria-hidden", "true"), x.find("*").attr("aria-hidden", "true"), o || (v.each(m.intro), x.each(m.outro)), i.immediate && !p) {
                        f(v).set(h), C();
                        return
                    }
                    if (t.index !== t.previous) {
                        if (o || t.ariaLiveLabel.text(`Slide ${n+1} of ${r.length}.`), "cross" === w) {
                            var W = Math.round(y - y * a.crossOver),
                                A = Math.round(y - W);
                            R = "opacity " + W + "ms " + b, f(g).set({
                                visibility: ""
                            }).add(R).start({
                                opacity: 0
                            }), f(v).set({
                    ...
                    function C() {
                        v = e(r[t.index].els), x = t.slides.not(v), "slide" !== w && (h.visibility = "hidden"), f(x).set(h)
                    }
                }

                function D(t, i) {
                    var a, r, n, s, d = e.data(i, h);
                    if (d) {
                        if (r = (a = d).mask.width(), a.maskWidth !== r && (a.maskWidth = r, 1)) return M(d);
                        o && (s = 0, (n = d).slides.each(function(t, i) {
                            s += e(i).outerWidth(!0)
                        }), n.slidesWidth !== s && (n.slidesWidth = s, 1)) && M(d)
                    }
                }
                ...
                function M(t) {
                    ...
                    d < 0 && (d = 0), t.anchors = [{
                        ...
                        r - a > d && (i++, a += s, t.anchors[i - 1] = {
                            els: [],
                            x: r,
                            width: 0
                        }), n = e(l).outerWidth(!0), r += n, t.anchors[i - 1].width += n, t.anchors[i - 1].els.push(l);
                        var f = o + 1 + " of " + t.slides.length;
                        e(l).attr("aria-label", f), e(l).attr("role", "group")
                    }), t.endX = r, o && (t.pages = null), t.nav.length && t.pages !== i && (t.pages = i, function(t) {
                        var i, a = [],
                            r = t.el.attr("data-nav-spacing");
                        r && (r = parseFloat(r) + "px");
                        for (var n = 0, s = t.pages; n < s; n++)(i = e('<div class="w-slider-dot" data-wf-ignore />')).attr("aria-label", "Show slide " + (n + 1) + " of " + s).attr("aria-pressed", "false").attr("role", "button").attr("tabindex", "-1"), t.nav.hasClass("w-num") && i.text(n + 1), null != r && i.css({
                            "margin-left": r,
                            "margin-right": r
                        }), a.push(i);
